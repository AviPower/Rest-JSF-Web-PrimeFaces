...
public class Ventadetalle implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="vdetalle_id_seq")
    @SequenceGenerator(name="vdetalle_id_seq", sequenceName="vdetalle_id_seq", allocationSize=1)
    ...
    public String toString() {
        return "com.sgcv.rest.jsf.web.model.Ventadetalle[ id=" + id + " ]";
    }
