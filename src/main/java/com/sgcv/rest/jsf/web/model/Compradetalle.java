...
public class Compradetalle implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="cdetalle_id_seq")
    @SequenceGenerator(name="cdetalle_id_seq", sequenceName="cdetalle_id_seq", allocationSize=1)
    ...
    public String toString() {
        return "com.sgcv.rest.jsf.web.model.Compradetalle[ id=" + id + " ]";
    }
